...
const Header: React.FC = () => {
  ...
  return (
    <Box as='header' background='#fff' position='fixed' top={0} left={0} right={0} borderBottomWidth={1} width='100%' height='4rem' zIndex={4}>
        ...
        <Flex alignItems='center'>
          ...
          <Menu>
            <MenuButton as={Button} pr={6}>
              <Avatar size="sm" name={user[0].name} src="https://bit.ly/broken-link" marginRight={3} />
              <Text as='span' mr={2}>{user[0].name}</Text>
